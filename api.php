...
$sk = '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';
$lista = $_GET['lista'];
...
if(strpos($result3, '"seller_message": "Payment complete."' )) {
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $1 Charged ✅ @srf_cc <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
...
elseif(strpos($result2,'"code": "incorrect_cvc"')){
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: Security code is incorrect by @srf_cc</span><br>';
}
...
elseif(strpos($result2,'"cvc_check": "unchecked"')){
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE @SRFXDZ</span><br>';
}
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo '#DIE</span> CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE @SRFXDZ</span><br>';
