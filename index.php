		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					...
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/modbyparvez">CLICK HERE TO JOIN @ModByParvez </a> <br>
					...
					<select name="gate" id="gate" class="form-control" style="margin-bottom: 5px;"  
					    ...
					    <option> </option>
	            <option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/AUTH.php">AUTH [NO-CHARGE]:</option>
				<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/inr.php">Stripe Charge: ₹1</option>
				<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/inr50.php">Stripe Charge: ₹50</option>
				<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd0.5.php">Stripe Charge: $0.5</option>
				<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1.php">Stripe Charge: $1</option>
                <option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur0.5.php">Stripe Charge: €0.5</option>
                <option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur1.php">Stripe Charge: €1</option>
</select>
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/parvezonfire2">CLICK HERE BUY NON SK CHECKER </a> <br>		
...
Swal.fire({ title: "@SRF_CC", text: "Join Our Telegram Channel :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
